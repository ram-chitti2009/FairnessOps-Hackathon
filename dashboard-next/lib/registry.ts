...
const REGISTRY: Record<string, ModelContext> = {
  ...
  eicu: {
    useCase: "ICU Deterioration Risk Screening",
    outcome: "flagged for ICU care escalation",
    population: "Adult ICU Patients (eICU Collaborative Research Cohort)",
    department: "Critical Care",
    patientsPerMonth: 1200,
    complianceNote: "CMS AI Transparency & Bias Rule (2025)",
  },
  synthetic: {
    useCase: "Synthetic Patient Risk Monitor",
    outcome: "flagged for clinical review",
    population: "Simulated Multi-Site Patient Cohort",
    department: "Clinical AI Programme",
    patientsPerMonth: 5000,
    complianceNote: "CMS AI Transparency & Bias Rule (2025)",
  },
  cancer_survival: {
    useCase: "Cancer Survival Risk Assessment",
    outcome: "identified as high-risk for adverse outcome",
    population: "Oncology Patients (Multi-Site)",
    department: "Oncology",
    patientsPerMonth: 600,
    complianceNote: "CMS AI Transparency & Bias Rule (2025)",
  },
  readmission: {
